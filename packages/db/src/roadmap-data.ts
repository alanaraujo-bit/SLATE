        ...
        children: [
          {
            key: "P1-M5-T1",
            kind: "TASK",
            title: "Serviço de sinalização",
            gates: [
              g("mesmo-servico", "WSS roda no mesmo processo de services/api"),
              g("autenticacao", "Conexão exige token curto obtido por desafio-resposta"),
              g("isolamento", "SDP e ICE só trafegam entre dispositivos ativos da mesma conta"),
              g("limites", "Origem, schema, tamanho, taxa e tempo de autenticação são limitados"),
              g("teste-real", "Upgrade e roteamento são cobertos com clientes WebSocket reais"),
            ],
          },
          {
            key: "P1-M5-T2",
            kind: "TASK",
            title: "Implementação do par no navegador",
            gates: [
              g("negociacao", "PWA negocia oferta, resposta e candidatos ICE por sinalização"),
          ...
          },
          {
            key: "P1-M5-T3",
            kind: "TASK",
            title: "Implementação do par no Agente (Rust)",
            gates: [
              g("compilacao", "Par WebRTC compila para Windows com a cadeia MSVC suportada"),
              g("identidade", "Agente assina o próprio fingerprint e verifica o da superfície"),
              g("interoperabilidade", "Agente e navegador abrem DataChannel entre si"),
              g("sem-porta-local", "Build de produção não expõe servidor HTTP ou WebSocket local"),
            ],
          },
          {
            key: "P1-M5-T4",
            kind: "TASK",
            title: "Fallback por retransmissão (TURN)",
            gates: [
              g("credencial-curta", "Credenciais TURN temporárias são entregues sem segredo no frontend"),
              g("relay-forcado", "Teste com política relay prova tráfego por TURN"),
              g("transparente", "Aplicação usa o mesmo DataChannel nos caminhos direto e retransmitido"),
            ],
          },
          {
            key: "P1-M5-T5",
            ...
            gates: [
              g("oito-estados", "Os oito estados existentes são derivados de eventos reais"),
              g("reconexao", "Queda real aciona ICE restart e retentativa com backoff"),
              g("sem-fila", "Comandos não ficam acumulados enquanto a conexão está inoperável"),
            ],
          },
          {
            key: "P1-M5-T6",
            ...
            gates: [
              g("timeout", "Timeout de sinalização e de abertura do canal é exercitado"),
              g("duplicidade", "Duplicidade e replay são recusados por teste que processa tráfego real"),
              g("obsoleto", "Timestamp fora da janela é recusado nas duas pontas"),
              g("versao", "Versão incompatível chega a VERSION_MISMATCH com orientação ao usuário"),
              g("seguranca", "Assinatura inválida e dispositivo revogado não estabelecem sessão"),
            ],
          },
        ],
      },
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            gates: [
              g("identidade", "Instalador tem identidade visual e textos próprios do SLATE"),
              g("portugues", "Instalação e desinstalação são apresentadas em português"),
              g("instalacao-real", "NSIS instala, abre e remove o Agente em Windows limpo"),
            ],
          },
          {
            key: "P3-M1-T4",
            kind: "TASK",
            title: "Início automático e atualização",
            gates: [
              g("busca-automatica", "Agente busca atualização sem interromper o uso"),
              g("assinatura", "Pacote adulterado ou sem assinatura válida é recusado"),
              g("experiencia", "Download, progresso, adiamento e reinício dizem o que é verdade"),
              g("publicacao", "Release real publica manifesto e pacote consumíveis pelo Agente"),
              g("inicio-automatico", "Pessoa pode controlar a inicialização junto com o Windows"),
            ],
          },
        ...
        children: [
          {
            key: "P3-M2-T1",
            kind: "TASK",
            title: "Contrato de ação e registro",
            gates: [
              g("registro", "Somente ações presentes no registro explícito podem executar"),
              g("validacao", "Envelope, timestamp, sequência e repetição são validados antes da ação"),
              g("escopos", "Agente exige os escopos da ação no par confiável"),
            ],
          },
          {
            key: "P3-M2-T2",
            kind: "TASK",
            title: "Pipeline de execução com retorno para a PWA",
            gates: [
              g("canal-real", "Pedido e resultado correlacionados atravessam o DataChannel real"),
              g("sem-fila", "Comando sem canal aberto é recusado sem ficar em fila"),
              g("retorno", "PWA mostra sucesso, recusa, queda ou tempo esgotado sem ambiguidade"),
            ],
          },
          {
            key: "P3-M2-T3",
            ...
            gates: [
              g("midia", "Controle de mídia executa no Windows a partir da PWA"),
              g("limites", "Entrada remota não permite tecla, atalho ou código arbitrário"),
            ],
          },
